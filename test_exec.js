...
const commandLine = ServerConfig.WebPanel.command(
  "PUBLIC_URL=/cat/pr/2",
  "create_react",
  [
    `'${JSON.stringify({ branchName: "tset", prNumber: 2, repo: "https://github.com/NeonGamerBot-QK/cat", outDir: "/home/saahild.com/public_html/cat" })}'`,
  ],
);
